        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleNameLocalized = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PermissionGroupTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PermissionGroupNamespace = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PermissionGroupTitleLocalized = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PermissionTitleLocalized = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PermissionIcon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AllowAnonymous = table.Column<bool>(type: "bit", nullable: false),
                    RequiresAuthorization = table.Column<bool>(type: "bit", nullable: false),
                    ActionFullName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
